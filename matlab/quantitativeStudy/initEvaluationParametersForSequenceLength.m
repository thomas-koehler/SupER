...
numberOfFrames = [(3:4:19).', ...   % Number of frames for binning factor 2
                 (3:4:19).', ...    % Number of frames for binning factor 3 
                 (3:4:19).'];       % Number of frames for binning factor 4
% Index of the first reference frame for sliding window processing.
startReferenceFrame = 10;
